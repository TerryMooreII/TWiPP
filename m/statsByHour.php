...
<div id="content">
	...
	<ul class="pageitem">
		...
		<?php
		for ( $d = 0; $d <24; $d++) {
			$hour = twatchCounterResult( TwatchCounter::DIST_HOURLY, $periodType, $aDateInfo[0] , $d, $group, $websiteID );
			?>
			<li class="menu"><span class="name"><?php echo $d . ":00" ?></span><span class="comment"><?php echo $hour ?></span></li>
			<?php
		} ?>
